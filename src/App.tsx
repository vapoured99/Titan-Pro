                  ...
                  >
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between border-b border-white/5 pb-5 relative">
                        ...
                        <div>
                          <span className="text-xs font-mono font-bold tracking-[0.4em] text-gym-accent uppercase block">TEMPLE INTELLIGENCE RECORD</span>
                        ...
                        <div className="text-right font-mono text-[11px] text-white leading-relaxed font-medium">
                          ...
                          <div className="text-gym-accent font-bold">ARCHIVE SEC : #{Math.floor(Math.random() * 90000) + 10000}</div>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-12 gap-5 items-stretch">
                        ...
                        <div className="col-span-4 bg-white/[0.015] border border-white/10 rounded-sm p-4 flex flex-col items-center justify-between text-center relative overflow-hidden">
                          <span className="text-[10px] font-mono font-bold tracking-widest text-white uppercase block">AVATAR SPECIMEN</span>
                          ...
                          <div className="space-y-0.5">
                            <h4 className="text-base font-light italic font-serif text-white">{profile?.displayName || currentUser?.displayName || "Athlete Specimen"}</h4>
                        ...
                        <div className="col-span-8 bg-white/[0.015] border border-white/10 rounded-sm p-5 flex flex-col justify-between relative overflow-hidden">
                          <div>
                            <span className="text-[10px] font-mono font-bold tracking-widest text-white uppercase block">METRIC CONSOLE</span>
                            
                            <div className="grid grid-cols-2 gap-x-6 gap-y-4 mt-4">
                              <div className="space-y-0.5 pb-2 border-b border-white/5">
                                <span className="text-[11px] font-mono font-bold tracking-widest text-white uppercase block">Captured Sessions</span>
                                <span className="text-xl font-bold text-gym-accent font-sans">{archivedWorkouts.length} SECURED</span>
                              </div>
                              <div className="space-y-0.5 pb-2 border-b border-white/10">
                                <span className="text-[11px] font-mono font-bold tracking-widest text-white uppercase block">Volume Lifted</span>
                                <span className="text-xl font-bold text-gym-accent font-sans">{(totalLifetimeVolume || 0).toLocaleString()} <span className="text-[11px] text-white font-semibold">kg</span></span>
                              </div>
                              <div className="space-y-0.5">
                                <span className="text-[11px] font-mono font-bold tracking-widest text-white uppercase block">Active Training Days</span>
                                <span className="text-xl font-bold text-gym-accent font-sans">{profile?.streakCount || 0} Streak</span>
                              </div>
                              <div className="space-y-0.5">
                                <span className="text-[11px] font-mono font-bold tracking-widest text-white uppercase block">Energy Reserves</span>
                                <span className="text-xl font-bold text-gym-accent font-sans">{(profile?.avatarCredits || 0).toLocaleString()} CR</span>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="border-t border-white/5 pt-4 mt-5 flex items-center justify-between">
                            <div>
                              <span className="text-[10px] font-mono font-bold tracking-widest text-white uppercase block">RANKING CLASSIFICATION</span>
                              <span className="text-lg font-serif italic text-gym-accent block leading-none mt-1">{currentRankName}</span>
                            </div>
                      ...
                      <div className="bg-white/[0.015] border border-white/10 rounded-sm p-5 relative overflow-hidden">
                        <div className="flex items-center justify-between mb-4 relative z-10">
                          <div>
                            <span className="text-[10px] font-mono font-bold tracking-widest text-gym-accent uppercase block">TIMELINE DATA _01</span>
                            <span className="text-xs font-mono font-black text-white uppercase tracking-widest">Weight Log Analysis (kg)</span>
                          </div>
                        ...
                        <div className="h-32 w-full">
                          {weightHistory.length === 0 ? (
                            <div className="h-full flex flex-col items-center justify-center border border-white/5 border-dashed rounded-sm bg-black/40">
                              ...
                              <span className="text-[10px] text-white/55 uppercase tracking-widest">No physical logs archived</span>
                            </div>
                          ) : (
                            <ResponsiveContainer width="100%" height="100%">
                              <AreaChart 
                      ...
                      <div className="bg-white/[0.015] border border-white/10 rounded-sm p-5 relative overflow-hidden">
                        <div className="flex items-center justify-between mb-4 relative z-10">
                          <div>
                            <span className="text-[10px] font-mono font-bold tracking-widest text-gym-accent uppercase block">TIMELINE DATA _02</span>
                            <span className="text-xs font-mono font-black text-white uppercase tracking-widest">Training Volume Trend (kg)</span>
                          </div>
                          <span className="text-[10px] font-mono font-semibold text-white bg-white/10 px-2 py-0.5 border border-white/10 rounded-sm">
                        ...
                        <div className="h-32 w-full">
                          {archivedWorkouts.length === 0 ? (
                            <div className="h-full flex flex-col items-center justify-center border border-white/5 border-dashed rounded-sm bg-black/40">
                              ...
                              <span className="text-[10px] text-white/55 uppercase tracking-widest">No active training logs archived</span>
                            </div>
                          ) : (
                            <ResponsiveContainer width="100%" height="100%">
                              <AreaChart 
                      ...
                      <div className="bg-white/[0.015] border border-white/10 rounded-sm p-5 relative overflow-hidden">
                        <div className="flex items-center justify-between mb-4 relative z-10">
                          <div>
                            <span className="text-[10px] font-mono font-bold tracking-widest text-gym-accent uppercase block">TIMELINE DATA _03</span>
                            <span className="text-xs font-mono font-black text-white uppercase tracking-widest">Active Calorie Expenditure (kcal)</span>
                          </div>
                          <span className="text-[10px] font-mono font-semibold text-white bg-white/10 px-2 py-0.5 border border-white/10 rounded-sm">
                      ...
                      <div className="flex items-center justify-between border-t border-white/5 pt-5 mt-2 relative">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <span className="text-[10px] font-mono font-bold text-white uppercase tracking-[0.2em] block">SECURE CLOUD STORAGE</span>
                            <span className="text-[11px] text-white tracking-wider font-mono font-medium">ARCHIVE CORE ACCESS SIGN-OFF</span>
                          </div>
                        </div>
                        <div className="text-right">
                          <span className="text-[10px] font-mono font-bold text-white uppercase tracking-[0.2em] block">SECURE VERIFIED SIGNATURE</span>
                          <span className="text-sm font-serif italic text-gym-accent">TEMPLE COMMAND ADMIN</span>
                        </div>
                      </div>
                    </div>
                  </div>
